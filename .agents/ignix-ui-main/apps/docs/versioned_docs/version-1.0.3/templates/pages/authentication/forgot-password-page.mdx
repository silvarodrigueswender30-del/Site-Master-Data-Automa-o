...
description: A component with header, right sidebar, and footer that supports responsive design and various configuration options.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import ForgotPasswordDemo from '@site/src/components/Demo/ForgotPasswordDemo'
...
| `formCardHeader` | `React.ReactNode` | - | Backward compatible - custom header React node (alternative to `forgotPasswordHeader`) |
| `loginLink` | `React.ReactNode` | - | Optional override for login link node |
| `button` | `React.ReactNode` | - | Optional override for button node |
| `input` | `React.ReactNode` | - | Optional override for input node |
...
| `successMessage` | `string` | `"Check your email for a reset link"` | Success message to display |
| `navigateToLabel` | `string` | `"Back To Login"` | Label for the navigation/back button |
| `submitbuttonLabel` | `string` | `"Send Reset Link"` | Label for the submit button |
...
| `captcha` | `React.ReactNode` | - | CAPTCHA component to display |
| `captchaVerified` | `boolean` | - | Whether CAPTCHA is verified |
