...
sidebar_position: 6
title: Checkbox
description: A customizable checkbox component with multiple variants, sizes, and animations.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import { Checkbox } from '@site/src/components/UI/checkbox';
import { CheckboxDemo, CheckboxGroupDemo, CheckboxAnimationDemo } from '@site/src/components/Demo/CheckboxDemo';
