...
|------|------|---------|-------------|
| `content` | `ReactNode` | `-` | The tooltip content that accepts a string or any React element |
| `children` | `ReactNode` | `-` | The trigger element the tooltip is anchored to |
...
| `className` | `string` | `-` | Additional CSS classes applied to the tooltip bubble |