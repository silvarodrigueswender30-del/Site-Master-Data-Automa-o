...
| `glowEffect` | `boolean` | `false` | When `true`, renders an animated radial glow behind the switch when checked |
| `thumbClassName` | `string` |  `-`  | Additional Tailwind classes applied to the thumb element |
| `className` | `string` |  `-`  | Additional Tailwind classes applied to the root switch element |